package com.qsj.acojbackenduserservice.controller;
...
import static com.qsj.acojbackenduserservice.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> deleteUser(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        //删除用户创建的题目以及题目提交的记录
        questionFeignClient.deleteById(id);
